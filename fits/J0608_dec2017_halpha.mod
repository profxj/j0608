...
data read
  ../../j0608/data/spec/J0608_ALIS.ascii   specid=0   fitrange=[6563.0,6574.7]   loadrange=[6560.0,6577.0]   resolution=vfwhm(75.0vtie)   columns=[wave,flux,error]       label=Halpha
data end
